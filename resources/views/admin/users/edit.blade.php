...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Modifier L'etudiant <strong>{{ $users->email }}</strong></div>
                ...
                <div class="card-body">
                  <form action="{{route('admin.users.update', $users)}}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') ?? $users->email}}" required autocomplete="email" autofocus>
                            ...
                            <div class="form-group form-check">
                                <input type="checkbox" name="roles[]" id="{{ $role->id}}" class="form-check-input" value="{{ $role->id}}" 
