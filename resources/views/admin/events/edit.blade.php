...
<div class="container-fluid">
  @if (session('alert_scc'))
    ...
    <div class="text-right mb-2">
        <button type="button" class="btn btn-danger" data-mdb-toggle="modal" data-mdb-target="#exampleModal"><i class="fa fa-gear"></i></button>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="tab-content" id="ex1-content">
                    ...
                    <div class="tab-pane fade" id="ex1-tabs-3" role="tabpanel" aria-labelledby="ex1-tab-3"></div>
                    <!-- Tabs content -->
                </div>
            </div>
        </div>
